use crate::{
    file::{InputFile, InputFileVariant, InputMedia},
    markup::InlineKeyboardMarkup,
    message::{
        ChatActionKind, DeleteMessage, EditMessageCaption, EditMessageMedia,
        EditMessageReplyMarkup, EditMessageText, Location, Message, SendAnimation, SendAudio,
        SendChatAction, SendContact, SendDice, SendDocument, SendLocation, SendMediaGroup,
        SendMessage, SendPhoto, SendPoll, SendVenue, SendVideo, SendVideoNote, SendVoice, StopPoll,
    },
    user::User,
